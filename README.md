# Simple TSX
## A simple typescript + react boilerplate project

### Getting Started

Clone the repo, then change to the repo directory and run:

    $ yarn
    $ yarn start

The project should automatically start in a new tab in your browser. You can also navigate to `localhost:3000`
